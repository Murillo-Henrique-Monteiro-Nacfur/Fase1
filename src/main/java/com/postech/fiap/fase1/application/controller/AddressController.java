...
import static com.postech.fiap.fase1.application.assembler.AddressAssembler.*;
...
public class AddressController {
    ...
    public ResponseEntity<AddressDTO> create(@RequestBody AddressRequestDTO addressRequestDTO) {
        SessionDTO sessionDTO = sessionService.getSessionDTO();
        return ResponseEntity.status(HttpStatus.CREATED).body(addressService.createAddress(requestToModel(addressRequestDTO), sessionDTO));
    }
